...
export default function DashboardPage() {
  ...
  // Render Public Profile Preview outside the main container for full width
      ...
      <div className="w-full bg-white border-t border-gray-200 mt-8">
        <div className="px-4 sm:px-6 lg:px-8 py-4 border-b border-gray-100">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-sm text-gray-600">This is how visitors see your profile when they click on your listing card</p>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <p className="text-sm text-red-700">
                      <strong>Admin Mode:</strong> You are viewing as {impersonationData.userName}
                    </p>
                  </div>
                </div>
                <button
          ...
          <div className="flex items-center justify-between py-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600">Manage your business profile and listings</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="grid grid-cols-4 gap-4 text-center">
                <div className="bg-blue-50 rounded-[9px] p-3">
                  <p className="text-xs font-medium text-blue-600 mb-1">Profile Views</p>
                ...
                <div className="bg-emerald-50 rounded-[9px] p-3">
                  <p className="text-xs font-medium text-emerald-600 mb-1">Active Products</p>
                ...
                <div className="bg-purple-50 rounded-[9px] p-3">
                  <p className="text-xs font-medium text-purple-600 mb-1">Active Listings</p>
                ...
                <div className="bg-yellow-50 rounded-[9px] p-3">
                  <p className="text-xs font-medium text-yellow-600 mb-1">Store Rating</p>
          ...
          {dashboardTabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-6 py-3 rounded-[9px] border-2 border-black font-bold transition-all ${
                  isActive
                    ? 'bg-emerald-400 text-black shadow-[4px_4px_0px_0px_rgba(0,0,0,0.9)] transform translate-x-1 translate-y-1'
                    : 'bg-white text-gray-700 shadow-[4px_4px_0px_0px_rgba(0,0,0,0.9)] hover:bg-gray-50'
                }`}
              >
      ...
      {/* Render Public Profile Preview outside main container for full width */}
      {activeTab === 'profile' && renderPublicProfilePreview()}
    </div>
  )
