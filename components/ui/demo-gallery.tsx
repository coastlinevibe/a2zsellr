    ...
    <div className="w-full min-h-screen bg-gray-50 p-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">A2Z Business Gallery</h1>
          <p className="text-gray-600">Interactive circular image gallery with smooth animations</p>
        </div>
