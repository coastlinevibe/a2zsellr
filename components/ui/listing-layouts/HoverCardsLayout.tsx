...
export const HoverCardsLayout: React.FC<HoverCardsLayoutProps> = ({
  ...
  return (
    <>
    <div className="bg-white rounded-[9px] shadow-sm border border-gray-200 w-full max-w-md md:max-w-2xl lg:max-w-5xl mx-auto overflow-visible relative">
      <style>{`
      ...
      <div className="bg-green-50 border-b border-green-200 p-4 md:p-6 lg:p-8 relative">
        ...
        <div className="mb-4 pt-8 md:pt-10 lg:pt-12">
          <ListingMeta
            ...
            className="mb-2"
          />
          <h3 className={`font-bold text-gray-900 mb-2 text-lg md:text-xl lg:text-2xl listing-title ${!showAnimations ? 'hidden-animation' : ''}`}>{title}</h3>
          <div 
            className={`text-gray-700 text-sm md:text-base lg:text-lg leading-relaxed listing-description ${!showAnimations ? 'hidden-animation' : ''}`}
