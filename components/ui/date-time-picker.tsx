...
const DateTimePicker = ({ value, onChange, className = '' }: DateTimePickerProps) => {
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      if (showTimeDropdown && !(event.target as Element).closest('.time-dropdown-container')) {
          ...
          >
            <div className="bg-white border-2 border-black rounded-[9px] shadow-[8px_8px_0px_0px_rgba(0,0,0,0.9)] p-4 min-w-[320px]">
              ...
              <div className="mb-4">
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-[9px] p-3">
                    ...
                    >
                      <span className="flex items-center gap-2">
                        ...
                        <span className="font-medium text-black">
                          {selectedDateTime && !isNaN(selectedDateTime.getTime()) ? `${selectedDateTime.getHours().toString().padStart(2, '0')}:00` : 'Select hour...'}
                        </span>
                      </span>
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    Minutes auto-preserved from selected time
                  </p>
                </div>
              </div>
