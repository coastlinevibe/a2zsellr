...
export function ImageGallery({ images, className = "" }: ImageGalleryProps) {
  ...
  const onClick = (index: number) => {
    if (!disabled && index < images.length) setOpened(index)
  }
  ...
  if (images.length === 0) {
    return (
      <div className={`flex items-center justify-center bg-gray-50 min-h-[400px] rounded-[20px] ${className}`}>
  ...
  return (
    <div className={`flex items-center justify-center bg-gradient-to-br from-emerald-50 to-blue-50 min-h-[400px] font-sans ${className}`}>
